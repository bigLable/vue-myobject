...
<div>
  ...
  <div class="col-xs-12" >
    <el-carousel :interval="4000"  height="500px" type="card" arrow="never">
...
<h3 style="text-align: center;font-family:宋体 ;font-size: 24px">拍照，从选机开始</h3>
  ...
  <el-row class="" >
    <div class="col-md-3" v-for="shop in info3" >
      <div class="demo">
        <router-link :to="'/shops/'+shop.shopID">   <figure class="imghvr-flip-diag-2" style="background:rgba(0,0,0,0.8);height: 85px">  <img :src="shop.IMG1" alt="example-image"class="img-responsive">
